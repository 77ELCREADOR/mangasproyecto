...
function validacionRS(){
    ...
    var colonia = document.formulario1.colDU.value;    
	var cp = document.formulario1.cpU.value;
	var tel = document.formulario1.telU.value;
	var nomC= document.formulario1.nomCU.value;
	var cont=document.formulario1.contU.value;
	...
	if (nombre=="" || appat=="" || apmat=="" || curp=="" || colonia=="" || calle==""
        ...
        if(exp1===false){
			...
			alert("Los apellidos solo pueden contener letras, ingresa mas de un caracter");
			return false;
		}else if(exp4===false){
			alert("Curp erroneo");
			return false;
			...
			alert("El nombre de la cuenta solo pueden contener letras");
            return false;
        }else if(exp13===false){
			alert("La contraseña de la cuenta puede contener letras y numeros");
            return false;
            ...
            var lonomC=nomC.length;
            var locont=cont.length;
		...
		alert("El curp debe de tener 18 caracteres");
			...
			//	return false;
				...
				return false;
			}else if (lonomC>20 || locont>20) {
				alert("El nombre de usuario y la contraseña pueden contener hasta 20 caracteres");
				return false;
			}else{
				alert("bien");
				return true;
